...
| 2026-04-13 | [production-pipeline-failure-analysis](sessions/2026-04-13_production-pipeline-failure-analysis.md) | Replicated production inference+postprocessing pipeline; YOLOv5m = deployed model (confirmed by client); root cause: 65% of failures from get_sequence reorder (30%) + correct_regex bad substitutions (35%) |
